...
type PageName = 'home' | 'simulations' | 'dashboard' | 'profile' | 'detail' | 'quiz';
...
function initializeApp() {
    ...
    // Quick Actions
    reviewActionCard.addEventListener('click', () => navigateTo('profile'));
...
function navigateTo(pageName: PageName) {
    ...
    } else if (pageName === 'detail' || pageName === 'quiz') {
